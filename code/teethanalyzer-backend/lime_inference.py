...
# ==================== PREDICTOR LOGIC ====================
class LIMEPredictor:
    """LIME-enabled predictor for TongueVision V6"""
    ...
    def __init__(self):
        ...
        logger.info("Loading TongueVision model...")
        self.model = TongueVision(num_classes=NUM_CLASSES)
